            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  // fontFamily: 'ProtestStrike',
                  fontSize: SizeHelper.isMobile(context) ? 17 : 19,
                ),
              ),
              const SizedBox(height: 4),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: AppColors.green700,
                        fontSize: SizeHelper.isMobile(context) ? 13 : 14,
                      ),
                      maxLines: 3,
                    ),
                  ],
  ...
  List<Widget> _aboutChildren(BuildContext context) {
      ...
      children: [
        ...
        _journeyItem(
          ...
          items: SizeHelper.isMobile(context)
              ? [
                  'Beginn des Studiums der Computertechnik\nan der IAU-Universität | Teheran, Iran',
    ...
    return [
      (SizeHelper.isMobile(context)
          ? _first
          : Expanded(
              flex: SizeHelper.isMobile(context) ? 2 : 5, child: _first)),
      const SizedBox(width: 50),
      SizeHelper.isMobile(context)
          ? _second
          : Expanded(flex: 6, child: _second),
    ];
  }
}
